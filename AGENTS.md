...
| `./scripts/create_github_repo_and_push.sh chocherie` | Create **GoldSignal_V2** under **chocherie** and push `main` (requires `export GITHUB_TOKEN=…` PAT with **repo**); see `docs/reports/github-push-GoldSignal_V2.md` |
